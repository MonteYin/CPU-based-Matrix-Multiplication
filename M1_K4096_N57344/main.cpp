...
int main() {
    ...
    // Optimized implementation (FP4 version)
    ...
    double avg_fp4_time = std::accumulate(fp4_times.begin() + 2, fp4_times.end() - 2, 0.0) / 96;
    ...
    double avg_float_time = std::accumulate(float_times.begin() + 2, float_times.end() - 2, 0.0) / 96;
